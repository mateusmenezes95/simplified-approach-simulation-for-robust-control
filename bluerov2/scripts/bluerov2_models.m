...
benzon_model.linear_damping_coefficients.m_q = lipenitis_model.linear_damping_coefficients.m_q;
...
lower_model.added_mass_coeficcients.z_dow_w = min([manzanilla_model.added_mass_coeficcients.z_dow_w, ...
                                                    lipenitis_model.added_mass_coeficcients.z_dow_w, ...
                                                    benzon_model.added_mass_coeficcients.z_dow_w]);
...
lower_model.linear_damping_coefficients.m_q = min([manzanilla_model.linear_damping_coefficients.m_q, ...
                                                    lipenitis_model.linear_damping_coefficients.m_q, ...
                                                    benzon_model.linear_damping_coefficients.m_q]);
...
upper_model.added_mass_coeficcients.y_dot_v = max([manzanilla_model.added_mass_coeficcients.y_dot_v, ...
                                                    lipenitis_model.added_mass_coeficcients.y_dot_v, ...
                                                    benzon_model.added_mass_coeficcients.y_dot_v]);
upper_model.added_mass_coeficcients.z_dow_w = max([manzanilla_model.added_mass_coeficcients.z_dow_w, ...
                                                    lipenitis_model.added_mass_coeficcients.z_dow_w, ...
                                                    benzon_model.added_mass_coeficcients.z_dow_w]);
...
upper_model.linear_damping_coefficients.z_w = max([manzanilla_model.linear_damping_coefficients.z_w, ...
                                                    lipenitis_model.linear_damping_coefficients.z_w, ...
                                                    benzon_model.linear_damping_coefficients.z_w]);
upper_model.linear_damping_coefficients.m_q = max([manzanilla_model.linear_damping_coefficients.m_q, ...
                                                    lipenitis_model.linear_damping_coefficients.m_q, ...
                                                    benzon_model.linear_damping_coefficients.m_q]);
...
nominal_model.added_mass_coeficcients.z_dow_w = (lower_model.added_mass_coeficcients.z_dow_w + ...
                                                  upper_model.added_mass_coeficcients.z_dow_w)/2;
...
nominal_model.linear_damping_coefficients.m_q = (lower_model.linear_damping_coefficients.m_q + ...
                                                  upper_model.linear_damping_coefficients.m_q)/2;
